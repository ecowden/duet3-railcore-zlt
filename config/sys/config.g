...
M569.1 P50.0 T2 C10000 S200 R200.0 I40000 D0.050  E1:2       ; 1HCL address 50 Y / Front has a quadrature encoder with 10,000 CPR (TMC 10k)
M569.1 P51.0 T2 C10000 S200 R200.0 I40000 D0.050  E1:2       ; 1HCL address 51 X / Rear  has a quadrature encoder with 10,000 CPR (TMC 10k)
...
M204 P1500 T6000                                                ; set default print and travel accelerations (mm/s^2) "Quiet"
; M204 P4500 T10000                                             ; set default print and travel accelerations (mm/s^2) "Speedy"
...
M569 P50.0 Y12:6 B1 F2                                   ; X            - Set tpwmthrs so StealthChop @ 10.5mm/sec, thigh @ (disable)
M569 P51.0 Y12:6 B1 F2                                   ; Y            - Set tpwmthrs so StealthChop @ 10.5mm/sec, thigh @ (disable)
