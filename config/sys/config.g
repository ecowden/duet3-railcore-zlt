...
M106 P0 C"HotendIn" S0.5 H1 T10              ; set fan 0 name and value. Thermostatic control is turned on. *Fan Sunon MF2510V2 on Mosquito as intake.
M950 F1 C"out9" Q500                         ; create fan 1 on pin out9 and set its frequency
M106 P1 C"HotendOut" S0.5 H1 T10             ; set fan 1 name and value. Thermostatic control is turned on. *Fan Sunon MF2510V2 on Mosquito as exhaust.
